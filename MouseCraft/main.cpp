...
void Test_Rendering()
{
	...
	auto c_p1_physics = physicsSystem->createObject(10, 10, 5, 5, 0, PhysObjectType::MOUSE_DOWN);

	// add to mouse entity
	e1->AddComponent(c_p1_physics);

	// component_player2_physics 
	auto c_p2_physics = physicsSystem->createObject(0, 0, 5, 5, 0, PhysObjectType::CAT_DOWN);
