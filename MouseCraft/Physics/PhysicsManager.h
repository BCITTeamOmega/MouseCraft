...
constexpr auto PART_CATEGORY = 0x0001;
constexpr auto CONTRAPTION_UP_CATEGORY = 0x0002;
constexpr auto CONTRAPTION_DOWN_CATEGORY = 0x0004;
constexpr auto CAT_UP_CATEGORY = 0x0008;
constexpr auto CAT_DOWN_CATEGORY = 0x0010;
constexpr auto MOUSE_UP_CATEGORY = 0x0020;
constexpr auto MOUSE_DOWN_CATEGORY = 0x0040;
constexpr auto OBSTACLE_UP_CATEGORY = 0x0080;
constexpr auto OBSTACLE_DOWN_CATEGORY = 0x0100;
constexpr auto PLATFORM_CATEGORY = 0x0200;
constexpr auto WALL_CATEGORY = 0x0400;
...
constexpr auto MOUSE_UP_MASK = 0x02AB;
...
public:
	...
	PhysicsComponent* createObject(float x, float y, float w, float h, float r, ObjectType t);
private:
	b2World *world;
